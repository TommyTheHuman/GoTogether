            ...
            <div id=form_left>
                <fieldset name="myData">
                    ...
                    <div>
                        ...
                        <label>
                            Numero peronse: *<br>
                            <input name="numeropersone" size="2" type="numbers" placeholder="Es: 3" pattern="[0-9]{1,2}" required><br>
                        </label>
                        <label>
                            Prezzo: *<br>
                        ...
                        <label>
                            titolo: *<br>
                            <input name="titolo" size="15" type="text" placeholder="Es: Roma e i monumenti" pattern="[a-zA-Z\s]+" required><br>
                        </label>
                        <label>
                            Descrizione del viaggio<br>
                            <textarea name="descrizione" rows="7" cols="30" id="descrizione"></textarea>
                        </label>
                        <label>
                            immagine:<br>
